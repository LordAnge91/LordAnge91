...
<html lang="it" dir="ltr">
   ...
   <body>
      ...
      <nav><img class="navBack" src="../../../pictures/element/nav.jpg">
         ...
         <label class='cart'>
         <a href="../../2/Carr.php">
            <span class="fontRainbow placeCount" id="placeCount">0</span>
            ...
            <div  class="menu-box"><button id=menuClose class="closemenu placing">chiudi x</button>
               ...
               <div class="sub-menu myMainTab">
                  ...
                  <ul>
                     ...
                     <div class="sub-menu myMainTab2">
                        <ul>
                           <li><a href="../../Bevande/Birra_ed_Aperitivi/Aperitivi_alcolici.php">Aperitivi alcolici</a></li><br>
                           <li><a href="../../Bevande/Birra_ed_Aperitivi/Aperitivi_analcolici.php">Aperitivi analcolici</a></li><br>
                           <li><a href="../../Bevande/Birra_ed_Aperitivi/Birra_alcolica.php">Birra alcolica</a></li><br>
                           <li><a href="../../Bevande/Birra_ed_Aperitivi/Birra_analcolica.php">Birra analcolica</a></li>
                        </ul>
                     </div>
