...
<div class="shower">
   ...
   <a href="Secca.php"><div class="showerElem">Frutta secca</div></a>
   <a href="Fresche.php"><div class="showerElem">Verdure fresche</div></a>
   <a href="Scattolame.php"><div class="showerElemActive">Scattolame</div></a>
   <a href="Cereali&Legumi.php"><div class="showerElem">Cereali e legumi</div></a>

   <div class="showerElemSelected"><h1>Scattolame</h1></div>

</div>
<?php
   include_once ('../../includes/testdbhconn.php');
   $query = "SELECT * FROM products WHERE category = 'Frutta&Verdura' AND sub_category = 'VerduraScattolame';";
