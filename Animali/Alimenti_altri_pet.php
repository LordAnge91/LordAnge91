...
<div class="shower">
   ...
   <a href="Alimenti_altri_pet.php"><div class="showerElemActive">Alimenti altri Pet</div></a>
   <a href="Accessori_e_Igiene.php"><div class="showerElem">Accessori e Igiene</div></a>

   <div class="showerElemSelected"><h1>Alimenti altri pet</h1></div>
...
<?php
   ...
   $query = "SELECT * FROM products WHERE category = 'Animali' AND sub_category = 'AlimentiPet';";
