...
<div class="shower">
   ...
   <a href="Alimenti_Gatti.php"><div class="showerElem">Alimenti Gatti</div></a>
   <a href="Alimenti_altri_pet.php"><div class="showerElem">Alimenti altri Pet</div></a>
   <a href="Accessori_e_Igiene.php"><div class="showerElemActive">Accessori e Igiene</div></a>

   <div class="showerElemSelected"><h1>Accessori e Igiene</h1></div>
...
<?php
   ...
   $query = "SELECT * FROM products WHERE category = 'Animali' AND sub_category = 'AccessoriAnimali';";
