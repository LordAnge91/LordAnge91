...
<div class="shower">
   ...
   <a href="Alimenti_Cani.php"><div class="showerElemActive">Alimenti Cani</div></a>
   ...
   <div class="showerElemSelected"><h1>Alimenti Cani</h1></div>
...
<?php
   ...
   $query = "SELECT * FROM products WHERE category = 'Animali' AND sub_category = 'AlimentiCani';";
